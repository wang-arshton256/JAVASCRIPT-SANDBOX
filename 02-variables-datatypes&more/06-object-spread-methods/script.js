...
x = Object.keys(shop); //Using Object.keys method to get keys from an object and put them into an object.
x = Object.keys(shop).length; // Passing .length on object keys method To get length
x = Object.values(todo); // To get values in object
x = Object.entries(todo); // To get an array with arrays with key value pairs
x = todo.hasOwnProperty('name'); // Checks if the objects has a property of name in it
